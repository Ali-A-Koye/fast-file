...
var jsonGenerator = function (columns, dataArray, res, filename) {
    if (filename === void 0) { filename = "Json_".concat(new Date().getTime()); }
    return __awaiter(void 0, void 0, void 0, function () {
        var textToWrite, fileBuffer, myReadableStreamBuffer;
        return __generator(this, function (_a) {
            textToWrite = JSON.stringify(dataArray);
            ...
            res.attachment("".concat(filename, ".json"));
