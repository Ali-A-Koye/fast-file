...
var excelGenerator = function (columns, data, res, sheetname) {
    if (sheetname === void 0) { sheetname = "excel_".concat(new Date().getTime()); }
    return __awaiter(void 0, void 0, void 0, function () {
        var myWritableStreamBuffer, options, workbook, worksheet, i;
        return __generator(this, function (_a) {
            ...
            workbook = new exceljs_1.default.stream.xlsx.WorkbookWriter(options);
            ...
            workbook
                ...
                res.attachment("".concat(sheetname, ".xlsx"));
