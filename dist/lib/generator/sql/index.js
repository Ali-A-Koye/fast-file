...
var sqlGenerator = function (columns, dataArray, res, filename) {
    if (filename === void 0) { filename = "sql_".concat(new Date().getTime()); }
    return __awaiter(void 0, void 0, void 0, function () {
        var textToWrite, fileBuffer, myReadableStreamBuffer;
        return __generator(this, function (_a) {
            textToWrite = "";
            textToWrite += "INSERT INTO table_name ( \n";
            lodash_1.default.map(columns, function (column, i) {
            ...
            res.attachment("".concat(filename, ".sql"));
